...
export class rentacar1651517413261 implements MigrationInterface {
    name = 'rentacar1651517413261'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`vehicle\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` enum ('auto', 'vizijármű') NOT NULL DEFAULT 'auto', \`brand\` varchar(255) NOT NULL, \`brand_type\` varchar(255) NOT NULL, \`status\` enum ('szabad', 'kikölcsönzött', 'selejtezett') NOT NULL DEFAULT 'szabad', \`km\` int NOT NULL, \`license_plate_number\` varchar(255) NOT NULL, \`procurement_date\` datetime NOT NULL, \`daily_price\` int NOT NULL, \`km_price\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
